...
// const BOTTOM_SHEET_HEIGHT = SCREEN_HEIGHT * 0.5; // Set your fixed height here
...
//     //#endregion
//     width: SCREEN_WIDTH,
//     height: BOTTOM_SHEET_HEIGHT, // Fixed height
//     // shadow
//     shadowColor: "#000",
//     shadowOffset: {
//       width: 0,
    ...
    const { current: panResponder } = React.useRef(
      PanResponder.create({
        ...
        onPanResponderMove: (event, gestureState) => {
          // Prevent dragging up by restricting the translateY value
